...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ApplicationLauncher::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case CatalogList::Id: return CatalogList::kMetadataEntry;
    case CurrentApp::Id: return CurrentApp::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::ApplicationLauncher::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case LaunchApp::Id: return LaunchApp::kMetadataEntry;
    case StopApp::Id: return StopApp::kMetadataEntry;
    case HideApp::Id: return HideApp::kMetadataEntry;
