...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::Chime::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case InstalledChimeSounds::Id: return InstalledChimeSounds::kMetadataEntry;
    case SelectedChime::Id: return SelectedChime::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::Chime::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case PlayChimeSound::Id: return PlayChimeSound::kMetadataEntry;
