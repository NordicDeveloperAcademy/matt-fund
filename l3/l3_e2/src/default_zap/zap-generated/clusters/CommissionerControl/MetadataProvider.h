...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::CommissionerControl::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case SupportedDeviceCategories::Id: return SupportedDeviceCategories::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::CommissionerControl::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case RequestCommissioningApproval::Id: return RequestCommissioningApproval::kMetadataEntry;
    case CommissionNode::Id: return CommissionNode::kMetadataEntry;
