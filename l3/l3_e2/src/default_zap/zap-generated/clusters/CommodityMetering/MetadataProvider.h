...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::CommodityMetering::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case MeteredQuantity::Id: return MeteredQuantity::kMetadataEntry;
    case MeteredQuantityTimestamp::Id: return MeteredQuantityTimestamp::kMetadataEntry;
    case TariffUnit::Id: return TariffUnit::kMetadataEntry;
    case MaximumMeteredQuantities::Id: return MaximumMeteredQuantities::kMetadataEntry;
