...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ElectricalEnergyMeasurement::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    case CumulativeEnergyImported::Id: return CumulativeEnergyImported::kMetadataEntry;
    case CumulativeEnergyExported::Id: return CumulativeEnergyExported::kMetadataEntry;
    case PeriodicEnergyImported::Id: return PeriodicEnergyImported::kMetadataEntry;
    case PeriodicEnergyExported::Id: return PeriodicEnergyExported::kMetadataEntry;
    case CumulativeEnergyReset::Id: return CumulativeEnergyReset::kMetadataEntry;
