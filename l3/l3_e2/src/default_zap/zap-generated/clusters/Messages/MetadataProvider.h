...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::Messages::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case Messages::Id: return Messages::kMetadataEntry;
    case ActiveMessageIDs::Id: return ActiveMessageIDs::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::Messages::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case PresentMessagesRequest::Id: return PresentMessagesRequest::kMetadataEntry;
    case CancelMessagesRequest::Id: return CancelMessagesRequest::kMetadataEntry;
