...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::SoftwareDiagnostics::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case ThreadMetrics::Id: return ThreadMetrics::kMetadataEntry;
    case CurrentHeapFree::Id: return CurrentHeapFree::kMetadataEntry;
    case CurrentHeapUsed::Id: return CurrentHeapUsed::kMetadataEntry;
    case CurrentHeapHighWatermark::Id: return CurrentHeapHighWatermark::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::SoftwareDiagnostics::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case ResetWatermarks::Id: return ResetWatermarks::kMetadataEntry;
