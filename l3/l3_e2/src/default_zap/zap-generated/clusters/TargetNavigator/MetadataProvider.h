...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::TargetNavigator::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case TargetList::Id: return TargetList::kMetadataEntry;
    case CurrentTarget::Id: return CurrentTarget::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::TargetNavigator::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case NavigateTarget::Id: return NavigateTarget::kMetadataEntry;
