...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ThermostatUserInterfaceConfiguration::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case TemperatureDisplayMode::Id: return TemperatureDisplayMode::kMetadataEntry;
    case KeypadLockout::Id: return KeypadLockout::kMetadataEntry;
    case ScheduleProgrammingVisibility::Id: return ScheduleProgrammingVisibility::kMetadataEntry;
