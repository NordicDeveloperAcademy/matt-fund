...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::WebRTCTransportProvider::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case CurrentSessions::Id: return CurrentSessions::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::WebRTCTransportProvider::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case SolicitOffer::Id: return SolicitOffer::kMetadataEntry;
    case ProvideOffer::Id: return ProvideOffer::kMetadataEntry;
    case ProvideAnswer::Id: return ProvideAnswer::kMetadataEntry;
    case ProvideICECandidates::Id: return ProvideICECandidates::kMetadataEntry;
    case EndSession::Id: return EndSession::kMetadataEntry;
