...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::MediaInput::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case InputList::Id: return InputList::kMetadataEntry;
    case CurrentInput::Id: return CurrentInput::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::MediaInput::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case SelectInput::Id: return SelectInput::kMetadataEntry;
    case ShowInputStatus::Id: return ShowInputStatus::kMetadataEntry;
    case HideInputStatus::Id: return HideInputStatus::kMetadataEntry;
    case RenameInput::Id: return RenameInput::kMetadataEntry;
