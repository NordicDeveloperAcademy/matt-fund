...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::MeterIdentification::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case MeterType::Id: return MeterType::kMetadataEntry;
    case PointOfDelivery::Id: return PointOfDelivery::kMetadataEntry;
    case MeterSerialNumber::Id: return MeterSerialNumber::kMetadataEntry;
    case ProtocolVersion::Id: return ProtocolVersion::kMetadataEntry;
    case PowerThreshold::Id: return PowerThreshold::kMetadataEntry;
