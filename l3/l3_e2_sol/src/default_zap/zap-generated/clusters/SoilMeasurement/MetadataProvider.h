...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::SoilMeasurement::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case SoilMoistureMeasurementLimits::Id: return SoilMoistureMeasurementLimits::kMetadataEntry;
    case SoilMoistureMeasuredValue::Id: return SoilMoistureMeasuredValue::kMetadataEntry;
