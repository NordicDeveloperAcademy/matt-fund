...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::TemperatureControl::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case TemperatureSetpoint::Id: return TemperatureSetpoint::kMetadataEntry;
    case MinTemperature::Id: return MinTemperature::kMetadataEntry;
    case MaxTemperature::Id: return MaxTemperature::kMetadataEntry;
    case Step::Id: return Step::kMetadataEntry;
    case SelectedTemperatureLevel::Id: return SelectedTemperatureLevel::kMetadataEntry;
    case SupportedTemperatureLevels::Id: return SupportedTemperatureLevels::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::TemperatureControl::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case SetTemperature::Id: return SetTemperature::kMetadataEntry;
