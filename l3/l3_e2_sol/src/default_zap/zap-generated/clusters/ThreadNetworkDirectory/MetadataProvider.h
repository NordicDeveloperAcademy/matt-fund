...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ThreadNetworkDirectory::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case PreferredExtendedPanID::Id: return PreferredExtendedPanID::kMetadataEntry;
    case ThreadNetworks::Id: return ThreadNetworks::kMetadataEntry;
    case ThreadNetworkTableSize::Id: return ThreadNetworkTableSize::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::ThreadNetworkDirectory::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case AddNetwork::Id: return AddNetwork::kMetadataEntry;
    case RemoveNetwork::Id: return RemoveNetwork::kMetadataEntry;
    case GetOperationalDataset::Id: return GetOperationalDataset::kMetadataEntry;
