...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::TlsClientManagement::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case MaxProvisioned::Id: return MaxProvisioned::kMetadataEntry;
    case ProvisionedEndpoints::Id: return ProvisionedEndpoints::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::TlsClientManagement::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case ProvisionEndpoint::Id: return ProvisionEndpoint::kMetadataEntry;
    case FindEndpoint::Id: return FindEndpoint::kMetadataEntry;
    case RemoveEndpoint::Id: return RemoveEndpoint::kMetadataEntry;
