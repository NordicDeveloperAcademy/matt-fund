				       ...
				       uint16_t size, uint8_t *value)
{
	...
	/* STEP 4.2 - Split into separate checks and add a check for CustomOnOffAttribute */
...
/* STEP 4.1 - Define a callback for when the CustomOnOffCommand command from the OnOff cluster is received */
