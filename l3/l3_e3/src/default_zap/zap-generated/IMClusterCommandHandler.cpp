							  ...
							  TLV::TLVReader &aDataTlv)
{
	...
	bool wasHandled = false;
	{
		...
		case Commands::Generate::Id: {
			...
			TLVError = DataModel::Decode(aDataTlv, commandData);
			if (TLVError == CHIP_NO_ERROR) {
				wasHandled = emberAfRandomNumberGeneratorClusterGenerateCallback(
					apCommandObj, aCommandPath, commandData);
			}
			break;
		}
				  ...
				  CommandHandler *apCommandObj)
{
	...
	case Clusters::Groups::Id:
		errorStatus = Clusters::Groups::DispatchServerCommand(apCommandObj, aCommandPath,
								      aReader);
		break;
	...
	case Clusters::RandomNumberGenerator::Id:
		errorStatus = Clusters::RandomNumberGenerator::DispatchServerCommand(
			apCommandObj, aCommandPath, aReader);
		break;
	default:
