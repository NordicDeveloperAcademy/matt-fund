...
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(WindowStatus::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace WindowStatus
namespace AdminFabricIndex
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(AdminFabricIndex::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace AdminFabricIndex
namespace AdminVendorId
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(AdminVendorId::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace AdminVendorId
