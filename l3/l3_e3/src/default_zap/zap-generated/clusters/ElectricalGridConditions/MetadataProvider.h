...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ElectricalGridConditions::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case LocalGenerationAvailable::Id: return LocalGenerationAvailable::kMetadataEntry;
    case CurrentConditions::Id: return CurrentConditions::kMetadataEntry;
    case ForecastConditions::Id: return ForecastConditions::kMetadataEntry;
