...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::EnergyPreference::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case EnergyBalances::Id: return EnergyBalances::kMetadataEntry;
    case CurrentEnergyBalance::Id: return CurrentEnergyBalance::kMetadataEntry;
    case EnergyPriorities::Id: return EnergyPriorities::kMetadataEntry;
    case LowPowerModeSensitivities::Id: return LowPowerModeSensitivities::kMetadataEntry;
    case CurrentLowPowerModeSensitivity::Id: return CurrentLowPowerModeSensitivity::kMetadataEntry;
