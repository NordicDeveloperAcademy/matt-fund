...
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(RebootCount::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace RebootCount
namespace UpTime
{
...
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(TotalOperationalHours::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace TotalOperationalHours
namespace BootReason
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(BootReason::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace BootReason
...
{
inline constexpr DataModel::AttributeEntry
	kMetadataEntry(TestEventTriggersEnabled::Id, BitFlags<DataModel::AttributeQualityFlags>(),
		       Access::Privilege::kView, std::nullopt);
} // namespace TestEventTriggersEnabled
...
inline constexpr DataModel::AcceptedCommandEntry
	kMetadataEntry(TestEventTrigger::Id, BitFlags<DataModel::CommandQualityFlags>(),
		       Access::Privilege::kManage);
} // namespace TestEventTrigger
namespace TimeSnapshot
{
inline constexpr DataModel::AcceptedCommandEntry
	kMetadataEntry(TimeSnapshot::Id, BitFlags<DataModel::CommandQualityFlags>(),
		       Access::Privilege::kOperate);
} // namespace TimeSnapshot
namespace PayloadTestRequest
{
inline constexpr DataModel::AcceptedCommandEntry
	kMetadataEntry(PayloadTestRequest::Id, BitFlags<DataModel::CommandQualityFlags>(),
		       Access::Privilege::kManage);
} // namespace PayloadTestRequest
