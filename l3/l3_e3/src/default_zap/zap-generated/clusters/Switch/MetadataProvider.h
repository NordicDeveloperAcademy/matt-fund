...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::Switch::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case NumberOfPositions::Id: return NumberOfPositions::kMetadataEntry;
    case CurrentPosition::Id: return CurrentPosition::kMetadataEntry;
    case MultiPressMax::Id: return MultiPressMax::kMetadataEntry;
