...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::TimeFormatLocalization::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case HourFormat::Id: return HourFormat::kMetadataEntry;
    case ActiveCalendarType::Id: return ActiveCalendarType::kMetadataEntry;
    case SupportedCalendarTypes::Id: return SupportedCalendarTypes::kMetadataEntry;
