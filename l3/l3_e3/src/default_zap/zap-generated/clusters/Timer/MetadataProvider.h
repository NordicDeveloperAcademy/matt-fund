...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::Timer::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case SetTime::Id: return SetTime::kMetadataEntry;
    case TimeRemaining::Id: return TimeRemaining::kMetadataEntry;
    case TimerState::Id: return TimerState::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::Timer::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case SetTimer::Id: return SetTimer::kMetadataEntry;
    case ResetTimer::Id: return ResetTimer::kMetadataEntry;
    case AddTime::Id: return AddTime::kMetadataEntry;
    case ReduceTime::Id: return ReduceTime::kMetadataEntry;
