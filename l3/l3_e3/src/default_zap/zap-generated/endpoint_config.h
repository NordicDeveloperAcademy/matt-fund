		 ...
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                            \
			...
			{ZAP_EMPTY_DEFAULT(), 0xFFF10000, 1, ZAP_TYPE(BOOLEAN),                    \
			 ZAP_ATTRIBUTE_MASK(WRITABLE) |                                            \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* CustomOnOffAttribute */         \
			{ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                 \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                           \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000002, 0, ZAP_TYPE(ARRAY),                      \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FabricSceneInfo */              \
			{ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                 \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                           \
			{ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                      \
			...
			{ZAP_EMPTY_DEFAULT(), 0xFFF10000, 2, ZAP_TYPE(INT16S),                     \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* GeneratedNumber */                      \
			{ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                 \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                           \
			{ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */                      \
...
#define GENERATED_ENDPOINT_TYPES                                                                   \
	{                                                                                          \
		{ZAP_CLUSTER_INDEX(0), 11, 13}, {ZAP_CLUSTER_INDEX(11), 5, 23},                    \
...
#define FIXED_PROFILE_IDS                                                                          \
	{                                                                                          \
		0x0103, 0x0103, 0x0104                                                             \
	}

// Array of device types
#define FIXED_DEVICE_TYPES                                                                         \
	{                                                                                          \
		{0x00000012, 1}, {0x00000016, 4}, {0x0000010A, 1},                                 \
		{                                                                                  \
			0xFFF10001, 1                                                              \
		}                                                                                  \
	}
