...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ApplicationBasic::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    case ApplicationName::Id: return ApplicationName::kMetadataEntry;
    case ProductID::Id: return ProductID::kMetadataEntry;
    case Application::Id: return Application::kMetadataEntry;
    case Status::Id: return Status::kMetadataEntry;
    case ApplicationVersion::Id: return ApplicationVersion::kMetadataEntry;
    case AllowedVendorList::Id: return AllowedVendorList::kMetadataEntry;
