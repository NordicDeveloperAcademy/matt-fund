...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::AudioOutput::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case OutputList::Id: return OutputList::kMetadataEntry;
    case CurrentOutput::Id: return CurrentOutput::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::AudioOutput::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case SelectOutput::Id: return SelectOutput::kMetadataEntry;
    case RenameOutput::Id: return RenameOutput::kMetadataEntry;
