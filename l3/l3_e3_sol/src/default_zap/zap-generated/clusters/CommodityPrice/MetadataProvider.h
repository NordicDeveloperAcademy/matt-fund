...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::CommodityPrice::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    case Currency::Id: return Currency::kMetadataEntry;
    case CurrentPrice::Id: return CurrentPrice::kMetadataEntry;
    case PriceForecast::Id: return PriceForecast::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::CommodityPrice::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case GetDetailedPriceRequest::Id: return GetDetailedPriceRequest::kMetadataEntry;
    case GetDetailedForecastRequest::Id: return GetDetailedForecastRequest::kMetadataEntry;
