...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::ContentLauncher::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case AcceptHeader::Id: return AcceptHeader::kMetadataEntry;
    case SupportedStreamingProtocols::Id: return SupportedStreamingProtocols::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::ContentLauncher::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case LaunchContent::Id: return LaunchContent::kMetadataEntry;
    case LaunchURL::Id: return LaunchURL::kMetadataEntry;
