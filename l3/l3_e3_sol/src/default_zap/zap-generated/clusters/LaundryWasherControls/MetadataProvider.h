...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::LaundryWasherControls::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case SpinSpeeds::Id: return SpinSpeeds::kMetadataEntry;
    case SpinSpeedCurrent::Id: return SpinSpeedCurrent::kMetadataEntry;
    case NumberOfRinses::Id: return NumberOfRinses::kMetadataEntry;
    case SupportedRinses::Id: return SupportedRinses::kMetadataEntry;
