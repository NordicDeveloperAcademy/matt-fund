...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::PowerTopology::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case AvailableEndpoints::Id: return AvailableEndpoints::kMetadataEntry;
    case ActiveEndpoints::Id: return ActiveEndpoints::kMetadataEntry;
    case ElectricalCircuitNodes::Id: return ElectricalCircuitNodes::kMetadataEntry;
