...
//
// Cluster metadata information for cluster RandomNumberGenerator (cluster code:
// 4294048769/0xFFF1FC01) based on C:\ncs\matt-fund\l3\l3_e3_sol\src\default_zap\template.matter
#pragma once
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry,
			       Clusters::RandomNumberGenerator::Id> {
	static constexpr std::optional<DataModel::AcceptedCommandEntry>
	EntryFor(CommandId commandId)
	{
