...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::WaterHeaterManagement::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case HeaterTypes::Id: return HeaterTypes::kMetadataEntry;
    case HeatDemand::Id: return HeatDemand::kMetadataEntry;
    case TankVolume::Id: return TankVolume::kMetadataEntry;
    case EstimatedHeatRequired::Id: return EstimatedHeatRequired::kMetadataEntry;
    case TankPercentage::Id: return TankPercentage::kMetadataEntry;
    case BoostState::Id: return BoostState::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::WaterHeaterManagement::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case Boost::Id: return Boost::kMetadataEntry;
    case CancelBoost::Id: return CancelBoost::kMetadataEntry;
