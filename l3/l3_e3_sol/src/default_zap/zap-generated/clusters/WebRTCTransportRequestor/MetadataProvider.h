...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::WebRTCTransportRequestor::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case Offer::Id: return Offer::kMetadataEntry;
    case Answer::Id: return Answer::kMetadataEntry;
    case ICECandidates::Id: return ICECandidates::kMetadataEntry;
    case End::Id: return End::kMetadataEntry;
