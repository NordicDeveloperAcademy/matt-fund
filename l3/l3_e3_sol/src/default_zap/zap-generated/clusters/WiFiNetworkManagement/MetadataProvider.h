...
struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::WiFiNetworkManagement::Id>
{
  static constexpr std::optional<DataModel::AttributeEntry> EntryFor(AttributeId attributeId) {
    ...
    switch(attributeId) {
    case Ssid::Id: return Ssid::kMetadataEntry;
    case PassphraseSurrogate::Id: return PassphraseSurrogate::kMetadataEntry;
...
struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::WiFiNetworkManagement::Id>
{
  static constexpr std::optional<DataModel::AcceptedCommandEntry> EntryFor(CommandId commandId) {
    ...
    switch(commandId){
    case NetworkPassphraseRequest::Id: return NetworkPassphraseRequest::kMetadataEntry;
